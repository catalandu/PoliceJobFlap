Locales['en'] = {
  ...
  ['open_cloackroom'] = '          cloakroom %s\n press ~g~E~w~ to change clothes',
  ['open_cloackroom_keys'] = 'press ~g~E~w~ take the keys ',
  ['store_veh'] = '         parking place %s\n press ~g~E~w~ to store the vehicle',
  ['must_be_in_veh'] = '         parking place %s\n you must be in the vehicle',
  ['dont_have_keys'] = "      cloakroom %s\n you don't have keys",
  ['outfit_dressed'] = "You put on a saved outfit",
  -- Armory
  ...
  ['helicopter_despawn'] = 'press ~g~E~w~ to store the helicopter',
  ['must_be_in_hel'] = 'you must be in the helicopter',
